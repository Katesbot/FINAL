$(function () {
    ...
    $('.form-inline').submit(function () {
      ...
      if(!checkEmpty($this.find('#genderSelect'))){
        result=false;
      }
      if(!checkEmpty($this.find('#ethnicitySelect'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectLocation'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectEducation'))){
        result=false;
      }
      if(!checkEmpty($this.find('#maritalSelect'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectChocolate'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectCheeese'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectAlcohol'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectCoffee'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectCandy'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectScent'))){
        result=false;
      }
      if(!checkEmpty($this.find('#selectDressing'))){
        result=false;
      }
      if(!checkEmpty($this.find('#ageInput'))){
        result=false;
      }
      if(result==false) {
        return false;
      ...
      var $btn = $("#submit-form").button('loading');
